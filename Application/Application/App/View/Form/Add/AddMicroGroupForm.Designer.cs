namespace PMSXApplication.App.View.Form.Add {
  internal partial class AddMicroGroupForm {
    /// <summary>
    ...
    private void InitializeComponent() {
      ...
      this.Name = "AddMicroGroupForm";
      this.Text = "Thêm nhóm vi thể";
      this.Load += new System.EventHandler(this.AddMicroGroupForm_Load);
